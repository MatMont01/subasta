...
function url_archivos($v)
{
    return RAIZ . '/archivos/' . $v;
}

function script($v)
{
    echo '<script type="text/javascript" src="' . url('/application/assets/' . $v) . '"></script>';
}

function css($v, $media = 'all')
{
    echo '<link rel="stylesheet" type="text/css" media="' . $media . '" href="' . url('/application/assets/' . $v) . '" />';
}

function img($v)
{
    echo url('/application/assets/' . $v);
}
