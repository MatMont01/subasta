...
<!--        <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav">
        <li class="pull-left"><?php echo Usr::gCargo(); ?></li>
    </ul>
    <!-- SEARCH FORM -->
...
<!--                <a href="#" class="dropdown-item">
                ...
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item dropdown-footer">Sin Mensajes</a>
            </div>
        </li>
...
<!--                <div class="dropdown-divider"></div>
        ...
        <li class="nav-item">
            <!--<a class="nav-link" id="close" data-widget="control-sidebar" data-slide="true" href="#" role="button">-->
            <a class="nav-link" id="close_app" href="#" role="button">
