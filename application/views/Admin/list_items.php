    ...
    <body class="hold-transition sidebar-mini">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Gestion de Registro</a></li>
                                    <li class="breadcrumb-item active">Lista de Automóviles</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Gestion de Automóviles</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="">MODELO</th>
                                                    <th class="">COLOR</th>
                                                    <th class=""><?php if(isset($table) && $table[0]['TIPO_COMPRA'] == 'SUBASTA') echo 'CIUDAD'; else echo 'CANT.'; ?></th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td scope="row" ><?php if($table[$i]['TIPO_COMPRA'] == 'SUBASTA') echo $table[$i]['CIUDAD']; else echo $table[$i]['CANTIDAD']; ?></td>
                                                    <!--<td scope="row" ><?php echo $table[$i]['CONDICION_KILOMETRAJE'] ?></td>-->
                                                    <td scope="row" ><a href="#" data-id="<?php echo $table[$i]['ID'] ?>" data-toggle="modal" data-target="#edit_Modal"><i class="fas fa-edit"></i></a></td>
                                                    <td scope="row" ><button id="item<?php echo $table[$i]['ID'] ?>" type='button' class='btn btn-secondary btn-sm text-nowrap' data-id="<?php echo $table[$i]['ID'] ?>" data-img="<?php echo $table[$i]['NRO_IMAGEN']+1; ?>" data-toggle="modal" data-target="#image_Modal">Load Image</button></td>
                                                </tr>
                                                <?php } ?>	
                                            </tbody>					
                                        </table>
        ...
        <div id="edit_Modal" class="modal fade" role="dialog">
            ...
            <form method="post" action="" id="edit_form">
                ...
                <div class="modal-body" id="edit_items">
                ...
                <div class="modal-footer">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-default btn-secondary float-left left" data-dismiss="modal">Cerrar</button>
                                <button id="save_item" type="button" class="btn btn-primary float-right right">Guardar</button>
                            </div>
                        </div>
                    </div>
                </div>
