...
class Usr {
	...
	public static function isAdmin(){
		...
		if (Usr::gUsuario()=='garciaci') return true;
		if (Usr::gUsuario()=='barrerok') return true;
		if (Usr::gUsuario()=='francoj') return true;
		if (Usr::gUsuario()=='vargasmn') return true;
		if (Usr::gUsuario()=='valenzuelaan') return true;
		if (Usr::gUsuario()=='leony') return true;
		if (Usr::gUsuario()=='pizzarroe') return true;
